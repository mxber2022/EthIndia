...
const sampleHotels: Hotel[] = [
  ...
  },
  {
    ...
    reviewCount: 156,
    pricePerNight: 499,
    amenities: ['Ski-in/Ski-out', 'Spa', 'Restaurant', 'Fireplace', 'Free WiFi']
  }
];
...
const sampleReviews: Review[] = [
  {
    ...
    rating: 4,
    review: 'Excellent stay with outstanding service. The staff was very accommodating and the rooms were immaculate. The location is perfect for exploring the city.',
    date: '2024-03-15',
  ...
  },
  {
    ...
    rating: 5,
    review: 'Beautiful beachfront property with breathtaking views. The infinity pool is amazing and the breakfast buffet offers great variety.',
    date: '2024-03-10',
    verificationStatus: 'verified',
